    ...
    if Ball_Collide:
            if Ball_X_Coord < 380 or Ball_X_Coord > 20: 
                ...
                if abs(ball_xvelo) > 3.5:
                    ...
                    ball_xvelo = ball_xvelo * choice([1,1.05,1.5])
                    ball_yvelo = ball_yvelo * choice([1,1.05,1.5])
                #!!!If you want to change the velo more track a timer on how long buttons are held to move barriers
